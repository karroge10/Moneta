  ...
  demographicComparisons: [
    {
      ...
      change: '+9% higher than other users',
      icon: 'Wallet',
      iconColor: '#74C648',
    },
    {
      ...
      change: '-12% less than other users',
    ...
    },
    {
      ...
      change: '-4% less than other users',
      icon: 'Trophy',
      iconColor: '#FFA500',
    },
    {
      ...
      change: '+121% higher than other users',
      icon: 'BitcoinCircle',
      iconColor: '#FF8C00',
    },
    {
      ...
      change: '+4 higher than other users',
      icon: 'Heart',
      iconColor: '#AC66DA',
    },
