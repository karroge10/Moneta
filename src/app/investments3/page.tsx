...
export default function InvestmentsLayout3() {
  ...
  return (
    <main className="min-h-screen bg-[#202020]">
      ...
      {/* Desktop: Bento Grid Layout 3 - Wide Allocation (≥1536px) */}
      <div className="hidden 2xl:flex 2xl:flex-col 2xl:gap-4 2xl:px-6 2xl:pb-6">
        {loading ? (
          <>
          ...
          <>
            {/* Row 1: Update, Total Value, Total Invested, Allocation - all equal width */}
            <div className="grid grid-cols-4 gap-4">
            ...
            {/* Row 2: Performance Chart (50%) + Assets List (50%) */}
            <div className="grid grid-cols-2 gap-4">
